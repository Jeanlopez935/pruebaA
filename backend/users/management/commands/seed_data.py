...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        if created:
            ...
            self.stdout.write(f'Representative {rep_user.username} already exists')
        ...
        if created:
            ...
            self.stdout.write(f'Teacher {teacher_user.username} already exists')

        try:
            teacher = Teacher.objects.get(user=teacher_user)
        except Teacher.DoesNotExist:
            teacher = Teacher.objects.create(user=teacher_user, specialty='Matemáticas')
        ...
        if created:
            ...
            self.stdout.write(f'Student {student} already exists')
